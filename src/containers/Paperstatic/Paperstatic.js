        ...
        <div className="container">
          <div className={styles.paperTopContent}>
            ...
            <div className={styles.paperBadge}>
              ...
              <div className={styles.paperBadgePrice}>
                $1984{" "}
                <span className={`${styles.paperBadgePricePercent}`}>
                  (+7.00%)
                </span>
              </div>
              ...
              <ul className={styles.paperBadgeUsers}>
                {paper.authors.map((item) => (
                  <li
                    ...
                    className={styles.paperBadgeUsersItem}
                  >
                    <Avatar
                      src={AvatarImg}
                      title={item.name}
              ...
              <div className={styles.paperBadgeActions}>
                <Button
                  classes={`${styles.paperBadgeBtn} ${styles.paperBadgeBtnBuy}`}
                  type="button"
                  size="sm"
                  kind="fill"
                >
                ...
                <Button
                  classes={`${styles.paperBadgeBtn} ${styles.paperBadgeBtnSell}`}
                  type="button"
                  size="sm"
                  kind="fill"
                >
      ...
      <div className="container">
        <div className={styles.paperContent}>
          <div className={styles.paperAbstract}>
            ...
            <div className={styles.paperAbstractText}>
              Authors earn Rosetta rewards based on the ImpactScore of the
              paper. This ensures that all authors that produce{" "}
            ...
            <div className={styles.dropdown}>
              ...
              >
                ...
                <div className={styles.dropdownHeaderStatus}>
                  <ChevronIcon
                    style={{
                      transform: `rotate(${reward ? "0deg" : "180deg"})`,
                    }}
                  />
                </div>
              </header>
                    ...
                    <div className={styles.graphFrames}>
                      <button
                        className={`${styles.graphToggle} ${
                          key === "month" ? styles.graphToggleActive : ""
                        }`}
                        type="button"
                      ...
                      <button
                        className={`${styles.graphToggle} ${
                          key === "three" ? styles.graphToggleActive : ""
                        }`}
                        type="button"
                        onClick={() => setKey("three")}
                      >
                        3m
                      </button>
                      <button
                        className={`${styles.graphToggle} ${
                          key === "half" ? styles.graphToggleActive : ""
                        }`}
                        type="button"
                        onClick={() => setKey("half")}
                      >
                      ...
                      <button
                        className={`${styles.graphToggle} ${
                          key === "year" ? styles.graphToggleActive : ""
                        }`}
                        type="button"
                        onClick={() => setKey("year")}
                      >
                  ...
                  <div className={styles.rewards}>
                    <div className={styles.rewardsItem}>
                      ...
                      <div className={styles.rewardsItemContent}>
                        ...
                        <div className={styles.rewardsItemContentTitle}>
                          $9,333
                        </div>
                      </div>
                    </div>
                    <div className={styles.rewardsItem}>
                      <div className={styles.rewardsItemTitle}>
                        Critical discussion
                      </div>
                      <div className={styles.rewardsItemContent}>
                        <div className={styles.rewardsItemContentIcon}>
